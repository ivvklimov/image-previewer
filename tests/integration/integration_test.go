...
// buildURL формирует URL запроса к приложению.
// ВАЖНО: проверь, как у тебя парсится URL в хендлере!
// Возможные варианты:
//   - /fill/200/200/http://localhost:8081/gopher.jpg  (URL как часть path)
//   - /fill/200/200?url=http://localhost:8081/gopher.jpg  (URL как query param)
//
// Ниже используется вариант с path. Если у тебя query param — поправь.
